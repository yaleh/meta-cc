...
// DIR-084: the fixture builder that used to live in this file is now shared
// across the package — see codex_rollout_fixture_test.go's newCodexHome,
// writeCodexRollout, insertCodexThreads and
// setupCodexMultiSessionFixtureProject.
